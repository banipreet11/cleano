<x-app-layout>
	...
	<div class="user_container">
		...
		<div class="settings_left">
			<div class="tab">
				<button class="tablinks" id="defaultOpen" onclick="openCity(event, 'settings-domain')">
		...
		<div class="settings_right">
			...
			{{-- --------------------1--------------------------------- --}}
			<div class="tabcontent" id="settings-domain">
				<p>Customer Domain</p>
				...
				<div class="domain1">
					...
					<div class="domain2">
						...
						<p class="ext">External
							<a id="3-dots" href="#" onclick="showPopup()">
			...
			{{-- ---------------------2--------------------------- --}}
			<div class="tabcontent" id="settings-staff-account">
				<h3>Staff account</h3>
					...
					<table class="table" id="staff-table">
						...
						@foreach ($data as $user)
							<tr>
								<td>{{ $user->name }}</td>
								<td>{{ $user->role }}</td>
								<td class="staff-td"><span class="staff-td-text">{{ $user->contact }}</span> <span class="staff-td-dot"> <img
											src="IMAGES\ph_dots-three-vertical-bold.svg" alt=""> </span></td>
							</tr>
						@endforeach
				...
				<div class="notification-first-div">
					...
					<div class="notification-div2">
						...
						<div class="notification-div2-combined1">
							...
							<div class="notification-div2-content4">CleaneoApp Technologies India Pvt Ltd. &lt;no-reply@cleaneoapp.com &gt;
							</div>
						</div>
			...
			{{-- ----------------- 4 --------------------------- --}}
			<div class="tabcontent" id="settings-payment">
				<div class="settings-paytm">
					<div class="settings-paytm-heading" id="paytm-one">
						{{-- <div class="settings-paytm-heading"></div> --}}
						<img class="settings-paytm-heading-text" src="IMAGES\simple-icons_paytm.svg" alt="">
				...
				<div class="settings-payment-provider">
					...
					<div class="settings-payment-provider-one">
						...
						<div class="s-three">
							<label class="switch">
								<input class="slide-field" type="checkbox" checked>
				...
				<div class="settings-payment-mpm">
					...
					<div class="settings-payment-mpm-right">
						<label class="switch">
							<input class="slide-field" type="checkbox">
			...
			{{-- ----------------- 5 --------------------------- --}}
			<div class="tabcontent" id="settings-checkout">
				...
				<div class="settings-checkout-form">
					...
					<div class="settings-checkout-form-table">
						<div class="settings-checkout-form-input">
							<input class="form-controls" tpye="text" placeholder="Name">
							<input class="form-controls" tpye="text" placeholder="Mobile Number">
						</div>
						<div class="settings-checkout-form-input">
							<input class="form-controls" tpye="text" placeholder="Email Address">
							<input class="form-controls" tpye="text" placeholder="Country">
						</div>
						<div class="settings-checkout-form-input">
							<input class="form-controls" tpye="text" placeholder="Email Address">
							<input class="form-controls" tpye="text" placeholder="Country">
						...
						<div class="settings-checkout-form-input">
							<input class="form-controls" tpye="text" placeholder="City">
							<input class="form-controls" tpye="text" placeholder="State">
						</div>
					</div>
					...
					<div class="settings-checkout-form-table">
						<div class="settings-checkout-form-input">
							<input class="form-controls" tpye="text" placeholder="Locality / Area">
							<input class="form-controls" tpye="text" placeholder="Locality / Area">
						</div>
					</div>
				</div>
			...
			{{-- ----------------- 6 --------------------------- --}}
			<div class="tabcontent" id="settings-warehouse">
				settings-warehouse
			</div>

			{{-- ----------------- 7 --------------------------- --}}
			<div class="tabcontent" id="settings-delivery">
				settings-delivery
			</div>

			<div class="tabcontent" id="settings-returns">
				settings-returns
			</div>

			<div class="tabcontent" id="settings-tax">
				settings-tax
			</div>

			<div class="tabcontent" id="settings-extracharges">
				settings-extracharges
			</div>

			<div class="tabcontent" id="settings-seo">
				settings-seo
			</div>

			<div class="tabcontent" id="settings-languages">
				settings-languages
			</div>

			<div class="tabcontent" id="settings-support">
				settings-support
			</div>

			<div class="tabcontent" id="settings-policies">
				settings-policeis
			</div>

			<div class="tabcontent" id="settings-storetimings">
