        ...
        <div class="analytics_section">
            ...
            <div class="row sales_analytics_section ">
                <div class="col-lg-6 col-md-6 col-sm-12  left_section">
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6  mb-3">
                            <div class="card">
                                ...
                                <h4 class="d-flex justify-content-between black b_600">1204 <span
                                        class="green text_12 mt-3">+2.5%</span></h4>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6  mb-3">
                            <div class="card">
                                <p class="text_12 mb-3 ">Average Sales per day</p>
                                <h4 class="d-flex justify-content-between black b_600">5004 <span
                                        class="green text_12 mt-3">+2.5%</span></h4>
                            </div>
                        </div>
                        <div class="col-lg-6  col-md-6 col-sm-6 col-xs-6  mb-3">
                            <div class="card">
                                ...
                                <h4 class="d-flex justify-content-between black b_600">504 <span
                                        class="orange text_12 mt-3">+2.5%</span></h4>
                            </div>
                        </div>
                        <div class="col-lg-6  col-md-6 col-sm-6 col-xs-6  mb-3">
                            <div class="card">
                    ...
                    <div class="row product_service_graph_container px-1 mt-5 ">
                        <div class="col-lg-10">
                                        ...
                                        <div class="col-lg-12 mt-3">
                                            <div class="product_graph_cont">
                                                ...
                                                <div class="row mt-3">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 py-2">
                                                        <div class="d-flex">
                                                            <span class="text_10 light_orange"><i
                                                                    class="fa-solid fa-circle"></i></span>
                                                            <div class="d-flex justify-content-between px-2 w-100">
